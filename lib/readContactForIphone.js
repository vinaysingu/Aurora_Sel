...
utils.results(caps.browserdetails.browserName);
	...
	var xpath = "//div[contains(text(),'"+ a.VARIABLES.contact_fname +"')]"; //---------Opens the contact based on the contact first name given in 'contactData.js' file
	...
	browser.type(el27,a.VARIABLES.contact_fname,function(err){ //------ Enters the contact first name in the search field and hits 'Return' (specific for iphone)
	...
	/*browser.elementByXPath(b.readObj1.searchIcon_xpath, function(err, el28){
	browser.clickElement(el28, function(err){
	utils.pause(2000,function(){*/
	...
	browser.waitForElementByXPath(b.readObj1.readContact_xpath, 2000,function(err){
	...
	browser.elementByXPath(b.readObj1.clname_xpath, function(err,el24){
	browser.type(el24,' ', function(err){
	...
	browser.elementByXPathOrNull(b.readObj1.newToolBar_xpath, function(err, toolBarEl){
	browser.clickElement(toolBarEl, function(err){
	utils.pause(2000,function(){
	browser.elementByXPath(b.readObj1.refreshButton_xpath, function(err, el26){
	browser.clickElement(el26, function(err){	
